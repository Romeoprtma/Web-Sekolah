...
@section('home')
    <section id="home" class="text-center py-[50px] md:py-[100px] px-[20px] md:px-[50px] lg:px-[200px] flex flex-col md:flex-row justify-center items-center">
...
<section id="sejarah" class="bg-[#006633] w-full h-auto mt-[200px] md:mt-[500px] text-white relative">
